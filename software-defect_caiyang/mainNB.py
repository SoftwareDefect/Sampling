...
datasets=["npm","nova","broadleaf","spring-integration","neutron","brackets","tomcat","fabric","jgroups","camel"]
method = "NB"
for j in range(10):
    dataset=datasets[j]
    ...
    ooss.columns = ['Erecall', 'Eprecision', 'Efmeasure', 'ePMI', 'eIFA', 'ePopt', 'cErecall', 'cEprecision','cEfmeasure', 'cPMI', 'cIFA', 'cPopt', 'recall', 'precision', 'accuracy', 'F1', 'Pf', 'G1', 'AUC','MCC']
