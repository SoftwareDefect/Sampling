...
for j in range(10):
    ...
    for i in range(50):
        ...
        result = rf_smo_opt(trn_X, trn_y, class_weight=None)
    ...
    for i in range(50):
        ...
        smo[i, :] = rf_predict(nn_X, nn_y, tst_X, tst_y, effort, class_weight=None)
        print("smote is okay~")
...
best_koutpath = './output-optsmo/' + method + '-best_knova' + '.csv'
